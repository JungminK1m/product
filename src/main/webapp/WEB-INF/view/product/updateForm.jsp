        ...
        <body>
            ...
            <form action="/product/${product.id}/update" method="post">
                <table border="1">
                    ...
                    <tr>
                        <td><input type="text" value="${product.id}" readonly size="1"></td>
                        <td><input type="text" value="${product.name}" name="name" size="10"></td>
                        <td><input type="text" value="${product.price}" name="price" size="3"></td>
                        <td><input type="text" value="${product.qty}" name="qty" size="3"></td>
